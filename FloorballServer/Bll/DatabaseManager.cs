...
//        public static Dictionary<int,List<int>> GetAllPlayerAndMatchId()
//        {
//            using (var db = new FloorballEntities())
//            {
...
//                db.Matches.Include("Players").ToList().ForEach(m => dict.Add(m.Id, m.Players.Select(p => p.RegNum).ToList()));
//                return dict;
//            }
//        }

//        public static Dictionary<int, List<int>> GetAllPlayerAndTeamId()
//        {
//            using (var db = new FloorballEntities())
//            {
//                //List<List<int>> list = new List<List<int>>();
...
//                //return list;
//                Dictionary<int, List<int>> dict = new Dictionary<int, List<int>>();
//                db.Teams.Include("Players").ToList().ForEach(m => dict.Add(m.Id, m.Players.Select(p => p.RegNum).ToList()));
//                return dict;
//            }
//        }

//        public static Dictionary<int, List<int>> GetAllRefereeAndMatchId()
//        {
//            using (var db = new FloorballEntities())
//            {
//                //List<List<int>> list = new List<List<int>>();
...
//                //return list;
//                Dictionary<int, List<int>> dict = new Dictionary<int, List<int>>();
//                db.Matches.Include("Referees").ToList().ForEach(m => dict.Add(m.Id, m.Referees.Select(r => r.Id).ToList()));
//                return dict;
//            }
//        }
